      ...
      <div 
        className={
          `${active === match.team1.name ? "w-1/2  " 
            ...
            : "w-1/2 "}
           group absolute flex flex-row-reverse items-center justify-start gap-3 bg-gradient-to-l from-[#F39C12] to-[#FFA500] top-0 right-0 rounded-r-xl h-full cursor-pointer duration-300`}
        style={{
        ...
        <img 
          ...
          className={
            `${active === match.team2.name ? 'size-[4.5rem]' 
              ...
              : 'size-16 group-hover:size-[4.5rem]'} mr-4 drop-shadow-xl/50 duration-300`
            } 
          />
        <h2 
