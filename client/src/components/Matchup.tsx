    ...
    <div className="relative w-full h-20 bg-gradient-to-l from-30% from-[#667EEA] to-[#9333EA] rounded-xl flex items-center">
      ...
      <div 
        className={
          ...
          group flex items-center gap-3 relative w-1/2 h-full cursor-pointer duration-300`}
      ...
      <div 
        className={
          `${active === match.team1.name ? "w-1/2 opacity-50 hover:opacity-80 " :  active === match.team2.name ? "w-[63%] " : "w-1/2 "}
           group absolute flex flex-row-reverse items-center justify-start gap-3 bg-gradient-to-l from-[#F39C12] to-[#FFA500] top-0 right-0 rounded-r-xl h-full cursor-pointer duration-400`}
        style={{
