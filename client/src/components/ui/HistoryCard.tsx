  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full h-full text-primary">
        <h3 className="bg-gradient-to-r from-yellow-400 to-yellow-500 animate-gradient-bg text-white text-5xl font-bold text-center py-7">🏆 <br /> { historyCardProps.firstPlace }</h3>
        <h3 className="bg-[#C0C0C0] text-4xl font-bold text-center py-7">🥈 { historyCardProps.secondPlace }</h3>
        <h3 className="bg-[#b08d57] text-4xl font-bold text-center py-7 rounded-b-lg">🥉 { historyCardProps.thirdPlace} </h3>
      </div>
    </div>
  )
}
