...
const Team1: React.FC<Team1Props> = ({ selectedTeam, handleChange, match, matchPoints }) => {
  return (
    <div 
      className={
    ...
    >
      ...
      <WinPercent value={matchPoints || 0} team="team1" selected={ selectedTeam } isLive={ match.live } />
    </div>
  )
}
