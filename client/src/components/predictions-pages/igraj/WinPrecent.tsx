      ...
      <div 
        className={`
          ${ team === 'team1' ?
            ...
            :
            `
              bg-black/25 slide-in
              ${selected === 'team1' && 'opacity-50'} 
              ${!isLive && selected === 'team1' && 'group-hover:opacity-80'}
            `
          }
          py-1 lg:py-1 px-0 lg:px-1 rounded-lg backdrop-blur-md font-semibold text-xs lg:text-lg duration-300
        `}
