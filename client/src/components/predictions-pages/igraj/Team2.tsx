    ...
    >
      {
        ...
        <Image
          ...
          className={
            `${
              selectedTeam === 'team2'
                ? 'size-[4.5rem]'
                : !match.live && selectedTeam === 'team1'
                ? 'group-hover:size-[4.5rem] opacity-50 group-hover:opacity-80'
                : !match.live && 'group-hover:size-[4.5rem]'
            } size-16 mr-4 drop-shadow-xl/50 duration-300`
          }
          unoptimized
        />
        :
        <h2 className={
            `${selectedTeam === 'team2' ? 'text-[4.5rem]' 
              : !match.live && selectedTeam === 'team1' ? 'group-hover:text-[4.5rem] opacity-50 group-hover:opacity-80'
              : !match.live && 'group-hover:text-[4.5rem]'} text-[4rem] font-bold mr-4 drop-shadow-xl/50 duration-300`
            }>?</h2>
      }
      <h2 
        className={`${ !match.live && selectedTeam === 'team1' ? 'opacity-50 group-hover:opacity-80 ' : '' } 
          hidden md:block w-min 2xl:w-fit text-end text-3xl xl:text-4xl text-[#f9fafd] font-semibold ml-4 lg:ml-0 duration-300`}
      >
        { match.team2.name }
      </h2>
