...
export default function UsersView({ topUsers }: { topUsers: TopUser[] }) {
  ...
  return (
    <div className="w-full flex flex-col md:flex-none md:grid md:grid-cols-3 gap-3 mt-5 mb-4 md:mb-0 cursor-default">
      ...
      <div className="bg-amber-400/20 brightness-125 col-start-2 flex flex-col justify-center items-center h-35 rounded-lg border border-amber-500 text-amber-500 md:-translate-y-3 hover:-translate-y-5 duration-200">
        <h3 className="text-2xl">🏆</h3>
